...
var Page = /*#__PURE__*/function (_React$Component) {
  ...
  function Page(props) {
    ...
    _this = _super.call(this, props);
    var user = _store_js__WEBPACK_IMPORTED_MODULE_9__["default"].userData ? _store_js__WEBPACK_IMPORTED_MODULE_9__["default"].userData.user : null;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                query = "query { user {\n      signedIn givenName\n    }}";
                _context2.next = 3;
                return Object(_graphQLFetch_js__WEBPACK_IMPORTED_MODULE_8__["default"])(query, null, null, cookie);
